...
pub struct TierMutationPrepareRequest {
    ...
    pub revision: u64,
    #[prost(bytes = "bytes", tag = "4")]
    pub topology_fingerprint: ::prost::bytes::Bytes,
    #[prost(bytes = "bytes", tag = "5")]
    pub intent_record: ::prost::bytes::Bytes,
    #[prost(string, tag = "6")]
    pub intent_record_etag: ::prost::alloc::string::String,
    #[prost(uint64, tag = "7")]
...
pub struct TierMutationCommitRequest {
    ...
    pub topology_fingerprint: ::prost::bytes::Bytes,
    #[prost(string, tag = "5")]
    pub committed_config_etag: ::prost::alloc::string::String,
    #[prost(bytes = "bytes", tag = "6")]
    pub committed_config_digest: ::prost::bytes::Bytes,
    #[prost(uint64, tag = "7")]
    pub deadline_unix_millis: u64,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn prepare(
            ...
            self.inner
                ...
                .map_err(|e| tonic::Status::unknown(format!("Service was not ready: {}", e.into())))?;
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/node_service.TierMutationControlService/Prepare");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("node_service.TierMutationControlService", "Prepare"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn commit(
            &mut self,
            ...
            self.inner
                ...
                .map_err(|e| tonic::Status::unknown(format!("Service was not ready: {}", e.into())))?;
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/node_service.TierMutationControlService/Commit");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("node_service.TierMutationControlService", "Commit"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn abort(
            &mut self,
            ...
            self.inner
                ...
                .map_err(|e| tonic::Status::unknown(format!("Service was not ready: {}", e.into())))?;
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/node_service.TierMutationControlService/Abort");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("node_service.TierMutationControlService", "Abort"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod tier_mutation_control_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/node_service.TierMutationControlService/Prepare" => {
                    #[allow(non_camel_case_types)]
                    struct PrepareSvc<T: TierMutationControlService>(pub Arc<T>);
                    impl<T: TierMutationControlService> tonic::server::UnaryService<super::TierMutationPrepareRequest> for PrepareSvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<super::TierMutationPrepareRequest>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move { <T as TierMutationControlService>::prepare(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/node_service.TierMutationControlService/Commit" => {
                    #[allow(non_camel_case_types)]
                    struct CommitSvc<T: TierMutationControlService>(pub Arc<T>);
                    impl<T: TierMutationControlService> tonic::server::UnaryService<super::TierMutationCommitRequest> for CommitSvc<T> {
                        type Response = super::TierMutationControlResponse;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(&mut self, request: tonic::Request<super::TierMutationCommitRequest>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move { <T as TierMutationControlService>::commit(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/node_service.TierMutationControlService/Abort" => {
                    #[allow(non_camel_case_types)]
                    struct AbortSvc<T: TierMutationControlService>(pub Arc<T>);
                    impl<T: TierMutationControlService> tonic::server::UnaryService<super::TierMutationAbortRequest> for AbortSvc<T> {
                        type Response = super::TierMutationControlResponse;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(&mut self, request: tonic::Request<super::TierMutationAbortRequest>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move { <T as TierMutationControlService>::abort(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
